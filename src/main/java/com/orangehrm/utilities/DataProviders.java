...
public class DataProviders {
	...
	public static Object[][] validLoginData() {
		return getSheetData("validLoginData");  //sheetname here
	}
	
	@DataProvider(name = "invalidLoginData")
	public static Object[][] invalidLoginData() {
		return getSheetData("invalidLoginData"); //sheetname here
	}
	
	@DataProvider(name = "emplVerification")
	public static Object[][] emplVerification() {
		return getSheetData("emplVerification"); //sheetname here
	}
